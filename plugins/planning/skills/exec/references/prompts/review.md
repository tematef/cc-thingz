...
In your next assistant response, invoke_subagent with 5 entries in the Subagents array, each with TypeName "self" and a distinct Role and Prompt for one of the 5 specialists (quality, implementation, testing, simplification, documentation).
...
In your next assistant response, invoke_subagent with 2 entries in the Subagents array, each with TypeName "self" and a distinct Role.
